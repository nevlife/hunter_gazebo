...
private:
    ...
    bool useNoiseDistance = false;
    bool useNoiseAngularRay = false;
    float noiseDistanceMean = 0.0f;
    float noiseDistanceStdDevBase = 0.0f;
    float noiseDistanceStdDevRisePerMeter = 0.0f;
    ...
    rgl_node_t rglNodeNoiseDistance = nullptr;
    rgl_node_t rglNodeNoiseAngularRay = nullptr;
