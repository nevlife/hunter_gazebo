...
def generate_launch_description():
    ...
    # Set Ignition Gazebo model path (Fortress uses IGN_GAZEBO_RESOURCE_PATH)
    ...
    # Bridge between Ignition Fortress and ROS 2
    # Fortress uses ignition.msgs.* instead of gz.msgs.*
    bridge = Node(
